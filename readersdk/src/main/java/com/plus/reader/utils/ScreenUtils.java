...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight(){
        Resources resources = ApiManager.getInstance().getApplicationContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = ApiManager.getInstance().getApplicationContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics(){
        DisplayMetrics metrics = ApiManager.getInstance().getApplicationContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
