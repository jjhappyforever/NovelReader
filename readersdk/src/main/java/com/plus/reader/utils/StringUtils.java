...
import static com.plus.reader.utils.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id) {
        return ApiManager.getInstance().getApplicationContext().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs) {
        return ApiManager.getInstance().getApplicationContext().getString(id, formatArgs);
    }
